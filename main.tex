...
% * <mertins@gmail.com> 2018-06-25T12:23:25.301Z:
% 
% Resumo deve ser escrito todo em um único paragrafo.  Deixa tudo num paragrafo. Tenta mudar Este processo é feito.... para algo diferente. Não parece conectar bem com a frase.
% 
% ^ <mertins@gmail.com> 2018-07-03T12:06:42.935Z.
\begin{abstract}
...
O processo de desenvolvimento de fármacos é muitas vezes algo custoso financeiramente, que demanda muito tempo, recursos para serem realizados e em muitas vezes é feito por uma pessoa de forma manual. 

Esta questão foi melhorada ao longo dos anos, ao  ser realizado todo o processo computacionalmente, mais especificamente tendo, um software que examine a estrutura de uma célula ligante e também faça a comparação entre suas similaridades com outra célula, esta sendo a receptora, afim de ter um mapeamento de moléculas  que definem de ambas estruturas das  duas células.
% * <mertins@gmail.com> 2018-06-25T12:39:47.448Z:
% 
% Confuso este paragrafo
% 
% ^.

Conforme diz \cite{lybrand1995ligand}; 
"Conhecendo-se a estrutura 3D de uma proteína, uma análise
computacional pode apontar prováveis regiões de ligação. Com isso é possível determinar um conjunto de candidatos (compostos líderes) que possa ligar-se a essa região da proteína alvo. " 


% * <mertins@gmail.com> 2018-06-25T12:41:20.289Z:
% 
% Tem certeza que esta citação esta correta?
% 
% ^.

Seu principal objetivo é analisar e prever a melhor conformidade entre duas estruturas celulares.Ao aplicar o docking é possível descobrir a afinidade de ligação que estas duas moléculas possuem.
% * <mertins@gmail.com> 2018-06-25T13:04:01.418Z:
% 
% Seu? Quem? 
% A palavra objetivo leva a entender que é o objetivo do trabalho.
% 
% ^.

Sendo uma molécula considerada ligante e outra receptora,  quanto maior a afinidade  e conformidade ao realizarem uma união estiverem, melhor o encaixe entre duas moléculas.
% * <mertins@gmail.com> 2018-06-25T13:05:33.538Z:
% 
% Concordancia na frase não esta legal
% 
% ^.
Assim é feito com todas as moléculas de uma estrutura celular. 
% * <mertins@gmail.com> 2018-06-25T13:06:15.791Z:
% 
% Este ultimo periodo  não fez sentido para mim. O que queres dizer?
% 
% 
% ^.

Com isso foi possível ser estudado o comportamento de diversas estruturas celulares ao longo dos anos na área de biomedicina.
Todo o processo de comparação, mapeamento de estrutura e união de moléculas é chamado de Docking Molecular, também chamada de atracamento, acoplamento ou até ancoragem, e tem como objetivo  prever o melhor encaixe entre duas moléculas de diferentes células.
% * <mertins@gmail.com> 2018-06-25T13:08:06.736Z:
%
% * <mertins@gmail.com> 2018-06-25T13:11:57.459Z:
% Tenho o sentimento que esta informação do que é docking molecular deveria ter sido introduzido antes. 
% ^.
\end{comment}
...
\begin{comment}
É de conhecimento geral que a tecnologia evoluiu muito nos ultimos anos, em razão disso os softwares utilizados para docking de hoje em dia tem maior capacidade para processamento que os mais antigos, consequentemente os programas mais novos acabam tendo maior riquezas de detalhes ao explorar a estrutura celular, sendo visualizada em forma 3d. 
% * <mertins@gmail.com> 2018-06-25T13:13:41.466Z:
% 
% Tu já introduziu docking molecular. Agora não deve fazer novamente.
% 
% ^.

A evolução destes softwares permitiu que fosse aumentada a precisão em estimar os pontos de união, essa estimativa de resultados é gerada através de uma função de avaliação que utiliza diversos tipos de algoritmos para efetuar o cálculo, que vai desde algoritmos genéticos a MonteCarlo, Lamarca e outros.

Ainda que a evolução no estudo de docking foi consideravelmente melhorada graças a evoluções nas funções de avaliações de softwares, existem alguns casos que ainda não são tão precisos em avaliação, como por exemplo, validar estruturas muito grandes 
desconhecidas, novas ou mais complexas, que podem envolver mutações de substâncias celulares, isso acaba sendo um desafio para ser estudado futuramente.

Ao aplicar Redes Neurais Profundas (deep learning) em uma função de avaliação, pode ocorrer uma melhora, visto que ao ser separado todas etapas do docking, fazer avaliação em partes e treinar as redes para que classifiquem e predigam o resultado.
Desta maneira pode ser minimizado o esforço e aumentada a precisão. 
% * <mertins@gmail.com> 2018-06-25T13:19:01.725Z:
% Isto precisa ser melhor explicado.
% ^.
\end{comment}
...
\begin{comment}
O texto falará contará brevemente sobre a importância do docking molecular para poder estudar o comportamento das estruturas celulares, de como é importante para tanto para desenvolvimento de drogas e medicamentos quanto para o estudo de substâncias nocivas, vírus e seu comportamento com o corpo humano. Será mostrado exemplos de softwares que obtiveram sucesso ao aplicar esta técnica e qual abordagem é mais eficaz dependendo da aplicação. 
% * <mertins@gmail.com> 2018-06-25T13:20:19.789Z:
% falara/contará não fica bem. Pode ser mais direto, baseado no que será descrito em cada capitulo.
% ^.
\end{comment}
...
% * <mertins@gmail.com> 2018-06-25T13:22:40.526Z:
% 
% permitindo assim poder ter uma visão...  nao esta bom.
% Senti falta de um entendimento melhor sobre o que é  docking molecular na introdução, para aqui já sair compreendendo.
% 
% ^.
...
% * <mertins@gmail.com> 2018-06-25T13:25:13.708Z:
% 
% saber todas..
% 
% ^.
...
% * <mertins@gmail.com> 2018-06-25T13:32:54.626Z:
% 
% O que é em Geral? Não deveria estar no plural? Sitação não parece ok
% 
% Melhor tu reconstruir a tabela, com os textos em portugues. Dai deixa de ser figura e passa a ser tabela. Mantem na explicação da tabela que trata-se de informações obtidas do sliwoski
% 
% ^.
\begin{comment}
      \begin{figure}[!htb]
	\centering\includegraphics[width=10cm]{imagens/sucess_docking.png}
	\caption{Descobertas utilizando softwares de docking}
    \cite{sliwoski2014computational} 
	\end{figure}
\end{comment}
...
% * <mertins@gmail.com> 2018-06-25T13:35:00.655Z:
% 
% citação precisa ser revisada.
% 
% ^.
% * <mertins@gmail.com> 2018-06-25T13:35:56.068Z:
% 
% Rever texto. ... e qual o objetivo .... e qual abordagem....  Acho que um dos e é virgula
% 
% ^.
...
% * <mertins@gmail.com> 2018-06-25T13:37:30.625Z:
% 
% Parece ser necessário detalhar e explicar mais  a questão da abordagem e do processo rigido. Mesma coisa para o paragrafo abaixo relativo ao flexivel
% 
% ^.
...
% * <mertins@gmail.com> 2018-06-25T13:39:47.579Z:
% 
% Não  entendi
% 
% ^.
